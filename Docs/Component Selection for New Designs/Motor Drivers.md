...
modified:
  ...
  - 2025-11-08T11:40:33-07:00
---

# Types
Most of these chips still require output gate transistors.

- Integrated XXX. A chip that has everything already built in to drive. Replace XXX with the control algorithm. It still is standalone and space saving. 
- Driver. These have FETs and current sensors, but they still need a microchip to support. Has 3 PWM inputs usually
- Microcontroller. [[Microcontrollers]]. Useful for installing Simple FOC, it may be a good cheap option, but a microchip + driver takes up more space
...
| TI DRV8311  | Driver                 | 3-20v   | 5A            | $1.41                    |               | S and P variants have a 1 pwm input mode that automatically generates signals. Also SPI interface, which can be a driver | https://www.mouser.com/new/texas-instruments/ti-drv8311-bldc-motor-driver                                          |
...
| ST SPIN233  | Driver                 | 1.8-10v | 1.3A          | $1.96                    |               | Nice and simple triple half bridge, Smallest ESC. Over priced for functionality                                          | [STSPIN233 \| Product - STMicroelectronics](https://www.st.com/en/motor-drivers/stspin233.html)                    |
...
The application is a low cost FOC controller
